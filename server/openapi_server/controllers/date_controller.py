...
def dates_read_all(note=None):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        for note in notes:
            ...
            matches = re.finditer("([1-9]|0[1-9]|1[0-9]|2[0-9]|3[0-1])(/)" +
                                  "([1-9]|0[1-9]|1[0-2])(/)(19[0-9][0-9]|" +
                                  "20[0-9][0-9])", note._text)
            ...
            matches = re.finditer("([1-9][1-9][0-9][0-9]|2[0-9][0-9][0-9])",
                                  note._text)
            add_date_annotation(res, note, matches, "YYYY")

            matches = re.finditer("(January|February|March|April|May|June|" +
                                  "July|August|September|October|November|" +
                                  "December)", note._text, re.IGNORECASE)
